...
<section class="innovation_slider_sec">
    <div class="innovation_slider">
        <div class="video_iframe">
            <iframe width="100%" height="600" src="https://www.youtube.com/embed/281vjSc03k4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
</section>
<!--====== INNOVATION LAB END ======-->
...
<section class="inno_prog our_programs_sec">
    ...
    <p>At MindBox, We partner with schools to offer age/grade-appropriate programs across India. These Programs are designed to empower students to connect learnings of school curriculum with the experiential/technology driven curriculum offered by us.</p>
</section>
<!--====== OUR PROGRAMS END ======-->
...
<section class="innovation mindbox_sec digital_sec">
    ...
    <div class="d-flex p_slider justify-content-center">
        <div class="digi_card">
            <div class="card">
    ...
    <h1 class="text-uppercase mt-5">secondary programs</h1>
    ...
    <div class="d-flex s_slider justify-content-center">
        <div class="digi_card">
            <div class="card">
    ...
    <div class="position-relative">
        <div class="d-flex justify-content-center presence_ab flex-wrap">
            <div class="p-4 approachwidth">
                <img src="{{asset('public/images/innovation/Critical Thinking.png')}}">
            </div>
            <div class="p-4 approachwidth">
                <img src="{{asset('public/images/innovation/Collabiration.png')}}">
            </div>
            <div class="p-4 approachwidth">
                <img src="{{asset('public/images/innovation/Media Litracy.png')}}">
            </div>
        </div>
    </div>
</section>
...
<section class="mindbox_sec digital_sec">
    ...
    <div class="testimonial mt-5 text-center">
        <div>
            <div>
