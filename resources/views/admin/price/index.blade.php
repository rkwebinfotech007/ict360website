...
@section('content') 
 ...
 jQuery("#multiple37").jqGrid({
  ...
  url:'{{route("enquiryList")}}',
  postData: { "_token": "{{ csrf_token() }}" },
  datatype: "json",
  
   colNames:['Name','Email','Phone','Message','Created'], 
colModel:[
      {label:'view', name:'name',jsonmap:'name', sorttype:'' , width:50,title: false},        
        {label:'view', name:'email',jsonmap:'email', sorttype:'' ,search:false, width:30,title: false, },  
		{label:'view', name:'phone',jsonmap:'email', sorttype:'' ,search:false, width:30,title: false, },
		{label:'view', name:'message',jsonmap:'message', sorttype:'' ,search:false, width:30,title: false, },
