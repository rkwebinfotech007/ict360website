              ...
              <nav class="green">
                <div class="nav-wrapper">
                  ...
                  <div class="col s12 m7 l7 hide-on-med-and-down">
                    <ul class="right">
                     <li> <a onclick="createNewsletter()">  <button type="button" class="btn waves-effect waves-light black lighten-2" data-position="down" data-delay="20" data-tooltip="Add winner show case" class="tooltipped">Create Newsletter</button> </a> </li>
                    </ul>
                  </div>
                </div>
              </nav>
...
function  createNewsletter()
 ...
 jQuery("#multiple37").jqGrid({
  ...
  url:'{{route("newsletterList")}}',
  postData: { "_token": "{{ csrf_token() }}" },
  datatype: "json",
  
   colNames:['Title','File Path','Created Date','Action'], 
colModel:[
