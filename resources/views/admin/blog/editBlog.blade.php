...
<form action="{{route('edit')}}" method="post" class="wpcf7-form wpcf7-acceptance-as-validation" enctype="multipart/form-data">
...
<p id="successMsg" class="green-text" style="display:none;"></p>
    ...
    <div class="create_student" style="transition: transform 0ms ease-out; transform: translate3d(0px, 0px, 0px);">
        ...
        <div class="col-md-12 input-field" >
            ...
            <label for="MovieMaking" class="active">Blog Thumbnail Title</label>   
            <input name="title" class="title"  type="text"  value="{{$blog->title}}" required="" >
        </div>

        <div class="col-md-12 input-field" >
            <!-- <i class="material-icons prefix active">Sub Title</i> -->
            <label for="" class="active">Sub Title</label>   
            <input name="sub_title" class="title"  type="text"  value="{{$blog->sub_title}}" >
        </div>  
        ...
        <div class="col-md-12 col-sx-12">
            <div class="form-group create_blog">
              <label class="control-label" for="name">Blog Category <span class="star"></span></label>
                ...
                <option value="humour" @if($blog->category == 'humour') selected @endif >Humour</option>
                <option value="infographics" @if($blog->category == 'infographics') selected @endif >Infographics</option>
                <option value="riddle" @if($blog->category == 'riddle') selected @endif >Riddle</option>
                <option value="technology" @if($blog->category == 'technology') selected @endif >Technology</option>
                <option value="uncategorized" @if($blog->category == 'uncategorized') selected @endif >Uncategorized</option>
                <option value="young-inventors" @if($blog->category == 'young-inventors') selected @endif >Young Inventors</option>
                <option value="mindblog" @if($blog->category == 'mindblog') selected @endif >Mindblog</option>
                </select>
        ...
        <div class="row" id="file"> 
            ...
            <div class="file-field input-field col s12" >       
                ...
                <div class="upload_file"><img src="{{url('/public').$blog->file_path}}" height="60" /></div>
            </div>    
            </div>
		   ...
		   <div class="col-md-12 col-sx-12 input-field">
            <div class="form-group">
              <label class="control-label" for="name">keywords <span class="star"></span></label>
                ...
                <textarea id='keywords' name="keywords" class="materialize-textarea"  placeholder="Type some text"> {{ $blog->keywords}} </textarea>
             <span class="error contentError"></span>
            </div>
          </div>
            ...
            <div class="form-group">
              <label class="control-label" for="name">Description <span class="star"></span></label>
                ...
                <textarea id='description' class="materialize-textarea" name="description"  placeholder="Type some text">{{$blog->description}} </textarea>
             <span class="error contentError"></span>
            </div>
          </div>
