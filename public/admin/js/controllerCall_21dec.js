 ...
 //rootFolder ="http://localhost/corel/public/";
    ...
    function  SaveCertificationData()
       {   
        ...
        certificationName           = $("#certification").val();  
        ...
        $.ajax({
            ...
            data: {formdata,_token:_token},
                ...
                if(res.success){
                    swal({
                        title: 'Certification!',
                        text: 'Certification Create Successfully.',
                        type: 'success'
                    },function(){
    ...
    function  getcertificationEnable(id,status)
    {
        if(status==1)
        {
            ...
            swal({  title: "Are you sure?",
            text: "You want "+enable+" Certification",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: '#DD6B55',
            confirmButtonText: 'Yes',
...
function  getFeedbackEnable(id,status)
 ...
 function allEnablesFeedbackApp(id)
     ...
     if(id==1) {   
	   ...
	   var titletest    ="You want to enable Feedback Approval!";
	   var titlesuccess  ="Feedback Approval enabled Successfully.!";
	 }
	 if(id==2) {   
	 
	   var titletest    ="You want to disable Feedback Approval!";
	   var titlesuccess ="Feedback Approval disabled Successfully.!";
	 }
	 if(id==3) {   
	 
	   var titletest    ="You want to delete Feedback Approval!";
	   var titlesuccess ="Feedback Approval deleted Successfully.!";
